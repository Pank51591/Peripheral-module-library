...
void Time_Adjust(struct rtc_time *tm)
{
	  ...
	  RTC_SetCounter(mktimev(tm)-TIME_ZOOM);        //北京时间比格林威治时间早8个小时
...
#ifdef  USE_SEG_DISPLAY

     // Digital_Time_Process(tm);
	 ...
	 do 
	  {
			...
			scanf("%d",&temp_num);
//			temp_num = USART_ReceiveData(USART1);
